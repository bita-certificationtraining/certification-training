export const CertificationList = [
  ...
  },
  {
    ...
    subcategories: [
      {
        name: "Microsoft Azure Certified Associate",
        items: [
          {
            code: "SC-200",
      ...
      {
        name: "Microsoft Azure Certified Expert",
        items: [
          {
            code: "AZ-305",
      ...
      {
        name: "Microsoft Dynamic 365 Fundamentals",
        items: [
          {
            code: "MB-910",
      ...
      {
        name: "Microsoft Dynamic 365 Expert",
        items: [
          {
            code: "MB-102",
  ...
  },
  {
    ...
    subcategories: [
      {
        name: "CompTIA Core Certifications",
        items: [
          {
            code: "220-1101",
      ...
      {
        name: "CompTIA Infrastructure Certification",
        items: [
          {
            code: "CV0-003",
      ...
      {
        name: "CompTIA Cyber Security Certification",
        items: [
          {
            code: "CA0-003",
      ...
      {
        name: "CompTIA Data Analytics Certification",
        items: [
          {
            code: "DA0-001",
  ...
  {
    category: "GIAC Certification",
    subcategories: [
      {
        name: "GIAC Cyber Defense Certifications",
        items: [
          {
            code: "GMLE",
      ...
      {
        name: "GIAC Cyber Security Certification",
        items: [
          {
            code: "GISP",
      ...
      {
        name: "GIAC Pen Testing Certification",
        items: [
          {
            code: "GCIH",
      ...
      {
        name: "GIAC Cloud Security Certification",
        items: [
          {
            code: "GCSA",
...

{
  ...
  {
    category: "ISACA Certification",
    subcategories: [
      {
        name: "ISACA IT Governance Certification",
        items: [
          {
            code: "CISM",
